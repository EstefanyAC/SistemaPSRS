...
<body>
    <div class="principal">
        ...
        <?php
          ...
          $sql = "UPDATE registro SET peso_papel = '".$peso_papel_nuevo."', peso_carton = '".$peso_carton_nuevo."' , peso_vidrio = '".$peso_vidrio_nuevo."', peso_plastico = '".$peso_plastico_nuevo."', monto_total = '".$monto_total_nuevo."'";
