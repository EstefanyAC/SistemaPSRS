...
<body>
    <div class="principal">
        ...
        <?php
          ...
          $sql = "INSERT INTO registro (id_reciclador, id_casa, peso_papel, peso_carton, peso_vidrio, peso_plastico, monto_total, id_estado, descripcion) ";
          $sql .= "VALUES ('$id_reciclador', '$id_casa', '$peso_papel', '$peso_carton', '$peso_vidrio', '$peso_plastico', '$monto_total', '$id_estado', '$descripcion' )";
